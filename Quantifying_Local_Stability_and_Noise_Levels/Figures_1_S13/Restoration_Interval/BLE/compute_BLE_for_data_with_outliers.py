...
def main():
	...
	noise_grid = np.linspace(0,0.04,n_noise_grid_points)
	slope_grid = np.linspace(-0.05, 0.05,n_slope_grid_points)
	...
	data_model.fast_resilience_scan(window_size, window_shift, slope_grid, noise_grid, nsteps = nsteps, 
									n_slope_samples = n_slope_samples, num_processes = num_processes,
									slope_save_name='slopes_without_outlier_correction',
									noise_level_save_name='noise_without_outlier_correction') # For the rest, default options are used. 
	beta = tt.time()
