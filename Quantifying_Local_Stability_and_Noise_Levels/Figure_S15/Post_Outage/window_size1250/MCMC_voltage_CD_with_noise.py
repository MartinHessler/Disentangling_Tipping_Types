...
if __name__ == '__main__':
	...
	np.save('NM_slopes_CD.npy', NM_model.slope_storage)
	np.save('NM_noise_CD.npy', NM_model.noise_level_storage)

	plt.plot(time[window_size-1::window_shift],NM_model.slope_storage[0,:])
	plt.fill_between(time[window_size-1::window_shift],NM_model.slope_storage[1,:],NM_model.slope_storage[2,:], color = 'orange', alpha = 0.6)
	plt.fill_between(time[window_size-1::window_shift],NM_model.slope_storage[3,:],NM_model.slope_storage[4,:], color = 'orange', alpha = 0.4)
	plt.savefig('NM_slopes_CD.png')
	plt.show()

	plt.plot(time[window_size-1::window_shift],NM_model.noise_level_storage[0,:])
	plt.fill_between(time[window_size-1::window_shift],NM_model.noise_level_storage[1,:],NM_model.noise_level_storage[2,:], color = 'orange', alpha = 0.6)
	plt.fill_between(time[window_size-1::window_shift],NM_model.noise_level_storage[3,:],NM_model.noise_level_storage[4,:], color = 'orange', alpha = 0.4)
	plt.savefig('NM_noise_level_CD.png')
	plt.show()