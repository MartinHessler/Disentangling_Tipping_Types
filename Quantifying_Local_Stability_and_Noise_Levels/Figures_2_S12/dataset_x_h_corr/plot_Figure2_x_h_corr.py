...
for i in range(3):
	if i == 0:
		...
		ax1.plot(time[window_size + loop_range], markov_slope[0,:], lw = 3, color = 'b')
		ax1.plot(time, analytical_drift_slopes_to_plot, 'g', lw = 3)
		ax1.plot(time[window_size+loop_range], nonmarkov_slope[0,:], color = 'r', lw = 3, label = r'Estimate $\hat{\zeta}_{\rm NBLE}$')
		ax1.fill_between(time[window_size + loop_range], markov_slope[1,:], markov_slope[2,:], color = 'orange', alpha = 0.6)
		ax1.fill_between(time[window_size::window_shift],markov_slope[3,:], markov_slope[4,:], color = 'orange', alpha = 0.4)
		ax1.fill_between(time[window_size+loop_range], nonmarkov_slope[1,:],nonmarkov_slope[2,:], color = 'green', alpha = 0.6)
		ax1.fill_between(time[window_size+loop_range],nonmarkov_slope[3,:],nonmarkov_slope[4,:], color = 'green', alpha = 0.4)
		ax1.set_xticks([])
		...
		ax2.plot(time[window_size+loop_range], nonmarkov_slope[0,:], color = 'r', lw = 3)
		ax2.fill_between(time[window_size +loop_range], nonmarkov_slope[1,:],nonmarkov_slope[2,:], color = 'green', alpha = 0.6)
		ax2.fill_between(time[window_size +loop_range],nonmarkov_slope[3,:],nonmarkov_slope[4,:], color = 'green', alpha = 0.4)
		ax2.set_xticks([])
		...
		ax.axvline(time[early_critical_transition], color  = 'red', ls = ':', lw = 3)
		ax.plot(time[window_size+loop_range], markov_noise[0,:], color =  'blue', lw = 3)
		ax.fill_between(time[window_size+loop_range],markov_noise[1,:],markov_noise[2,:], color = 'orange', alpha = 0.6)
		ax.fill_between(time[window_size+loop_range],markov_noise[3,:],markov_noise[4,:], color = 'orange', alpha = 0.4)
		ax.plot(time[window_size+loop_range], nonmarkov_noise[0,:], color =  'r', label = r'Estimate $\hat{\Psi}$', lw = 3)
		ax.fill_between(time[window_size+loop_range],nonmarkov_noise[1,:],nonmarkov_noise[2,:], color = 'green', alpha = 0.6)
		ax.fill_between(time[window_size+loop_range],nonmarkov_noise[3,:],nonmarkov_noise[4,:], color = 'green', alpha = 0.4)
