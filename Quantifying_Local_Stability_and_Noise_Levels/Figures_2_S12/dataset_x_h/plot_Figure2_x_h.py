...
for i in range(3):
	if i == 0:
		...
		ax.fill_between(time[window_size + loop_range], markov_slope[1,:], markov_slope[2,:], color = 'orange', alpha = 0.6, label = r'CB $\epsilon$')
		ax.fill_between(time[window_size::window_shift],markov_slope[3,:], markov_slope[4,:], color = 'orange', alpha = 0.4)
		ax.plot(time[window_size + loop_range], markov_slope[0,:], lw = 3, color = 'b', label = r'$\hat{\zeta}$')
		ax.set_xticks([])
		...
		ax.plot(time[window_size::window_shift], markov_noise[0,:], color =  'b', lw = 3, label = r'$\hat{\sigma}$')
		ax.fill_between(time[window_size::window_shift],markov_noise[1,:], markov_noise[2,:], color = 'orange', alpha = 0.6,label = r'CB $\epsilon$')
		ax.fill_between(time[window_size::window_shift],markov_noise[3,:], markov_noise[4,:], color = 'orange', alpha = 0.4)
