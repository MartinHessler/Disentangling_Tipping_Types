...
data = np.load('BN_tipping_transition_cut.npy')
samples = 30000

r_array = np.linspace(10, -2, samples)
...
np.save('AR1_BN_tip_I.npy', AR1_array)
np.save('std_BN_tip_I.npy', std_array)

compare_AR1 = np.load('AR1_BN_tip_I.npy')
compare_STD = np.load('std_BN_tip_I.npy')
if show_indicators:
