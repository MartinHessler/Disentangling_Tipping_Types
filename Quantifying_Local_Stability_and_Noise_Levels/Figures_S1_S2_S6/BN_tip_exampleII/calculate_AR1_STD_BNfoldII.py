...
data = np.load('detrended_BN_II_tip_fold_cutted.npy')
samples = 30000
...
# np.save('AR1_BN_tip_II.npy', AR1_array)
# np.save('std_BN_tip_II.npy', std_array)

compare_AR1 = np.load('AR1_BN_fold_tip_II.npy')
compare_STD = np.load('STD_BN_fold_tip_II.npy')
...
if show_indicators:
	...
	axs[1].plot(time[window_size + loop_range], compare_AR1)
	axs[1].plot(time[window_size + loop_range], compare_STD)
	plt.show()